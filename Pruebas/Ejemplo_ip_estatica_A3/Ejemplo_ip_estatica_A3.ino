...
IPAddress ip_local(192, 168, 10, 90);
...
void loop() {
  WiFiClient cliente = servidor.available(); // cliente es el numero de clientes 
...
void VerificarMensaje(String Mensaje) { // "Mensaje" es el dato que viene en la LineaActual
