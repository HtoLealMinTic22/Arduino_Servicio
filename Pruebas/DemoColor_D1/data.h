...
<html>
  <head>
    ...
    <style>
      ...
      input[type="range"] {
       ...
       .p11{ text-align: center; top: 10px;}    
    </style>
  </head>
  ...
  <body>
     ...
     <div style = 'box-shadow: 0px 0px 20px 8px rgba(0,0,0,0.22); padding:5px; width:490px; height:400px; display: inline-block; margin: 30px; ' > 
       <center>
         <div id="botonSala"     class="vivo"><p1><h2>Luz sala .............:  <span class="pollo"><span class="huevo"> <p11 class="labelOff" id="label1Off">On</p11> </span></span></h2></p1></div>
         <div id="botonArcoiris" class="vivo"><p1><h2>Cascada y luces..:       <span class="pollo"><span class="huevo"> <p11 class="labelOff" id="label2Off">On</p11> </span></span></h2></p1></div>
         <div id="botonFiguras"  class="vivo"><p1><h2>Figuras ...............: <span class="pollo"><span class="huevo"> <p11 class="labelOff" id="label3Off">On</p11> </span></span></h2></p1></div>
         <div id="botonLuzEnt"   class="vivo"><p1><h2>Luz Entrada........:     <span class="pollo"><span class="huevo"> <p11 class="labelOff" id="label4Off">On</p11> </span></span></h2></p1></div>
    ...
    <script>
      ...
      function cambiarFiguras(){
        ...
        if(elementoEstado.className == "vivo"){elementoEstado.className = "muerto";
             ...
             label3Off.innerHTML = 'On';}
        console.log("Cambiando Figuras a " + elementoEstado.className)
      ...
      function cambiarLuzEnt(){
        ...
        if(elementoEstado.className == "vivo"){elementoEstado.className = "muerto";
             ...
             label4Off.innerHTML = 'On';}
        console.log("Cambiando LuzEnt a " + elementoEstado.className)
