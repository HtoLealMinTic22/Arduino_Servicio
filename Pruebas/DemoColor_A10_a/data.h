...
<html>
  ...
  <body>
    ...
    <script>
      ...
      const elementoBoton    = document.getElementById("botonGrabaUno");
      ...
      elementoBoton.addEventListener("click", cambiarHorario1);
